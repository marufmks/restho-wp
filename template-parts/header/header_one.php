...
<header class="header-area style-1 bg-color2">
    <div class="container-fluid d-flex justify-content-between align-items-center">
        <div class="header-logo">
            <?php
            if (!empty(Egns_Helpers::egns_page_option_value('header_one_logo', 'url'))) {
                Egns_Helpers::get_theme_logo(Egns_Helpers::egns_page_option_value('header_one_logo', 'url'));
            } else {
        ...
        <div class="header-logo header-sticky-logo">
            <?php
            if (!empty(Egns_Helpers::egns_page_option_value('header_one_sticky_logo', 'url'))) {
                Egns_Helpers::get_theme_logo(Egns_Helpers::egns_page_option_value('header_one_sticky_logo', 'url'));
            } else {
        ...
        <div class="main-menu">
            <div class="mobile-logo-area d-lg-none d-flex justify-content-between align-items-center">
                <div class="mobile-logo-wrap">
                    <?php
                    if (!empty(Egns_Helpers::egns_page_option_value('header_one_logo_mobile', 'url'))) {
                        Egns_Helpers::get_theme_logo(Egns_Helpers::egns_page_option_value('header_one_logo_mobile', 'url'));
                    } else {
            ...
            <?php if ((Egns_Helpers::egns_get_theme_option('header_one_right_side_contact') == 1) && class_exists('CSF')) : ?>
        ...
        <?php if ((Egns_Helpers::egns_get_theme_option('header_one_mobile_menu_contact') == 1) && class_exists('CSF')) : ?>
            <div class="nav-right d-flex jsutify-content-end align-items-center">
                ...
                <?php endif ?>
                <?php if (Egns_Helpers::egns_get_theme_option('header_one_button_url') && Egns_Helpers::egns_get_theme_option('header_one_right_side_button') == 1 && class_exists('CSF')) : ?>
                    <a href="<?php echo esc_url(Egns_Helpers::egns_get_theme_option('header_one_button_url')) ?>" class="primary-btn btn-md"><?php echo esc_html(Egns_Helpers::egns_get_theme_option('header_one_button_text')) ?></a>
                <?php endif ?>

                <?php if ((Egns_Helpers::egns_get_theme_option('header_one_menu_sidebar') == 1) && class_exists('CSF')) :  ?>

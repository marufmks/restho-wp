    ...
    <header class="header-area style-2">
        ...
        <div class="main-nav">
            ...
            <div class="d-xl-none d-lg-none d-block">
                <?php  if( class_exists('CSF') && !empty( Egns_Helpers::egns_get_theme_option('header_two_button_text') ) ) : ?>
                    <div class="eg-btn btn--primary btn--lg d-xl-none d-lg-none d-flex">
                        <a href="<?php echo esc_url( Egns_Helpers::egns_get_theme_option('header_two_button_link') ) ?>"><i class="bi bi-dash-lg"></i> <?php echo esc_html( Egns_Helpers::egns_get_theme_option('header_two_button_text') ); ?> </a>
                    </div>
                <?php endif ?>
            </div>
            <?php if( !empty( Egns_Helpers::egns_get_theme_option('header_two_mobile_menu_contact') ) && ( 1 == Egns_Helpers::egns_get_theme_option('header_two_mobile_menu_contact') ) ) : ?>
            <div class="phone-call d-flex d-lg-none justify-content-start align-items-center flex-row d-xl-none d-block mt-5">
                <div class="icon">
                ...
                <div class="number">
                    ...
                    <?php if( !empty( Egns_Helpers::egns_get_theme_option('header_two_mobile_menu_contact_phone') ) ) : ?>
                        <h5><a href="tel:<?php echo wp_kses( Egns_Helpers::egns_get_theme_option( 'header_two_mobile_menu_contact_phone' ), wp_kses_allowed_html('post') ) ?>"><?php echo wp_kses( Egns_Helpers::egns_get_theme_option( 'header_two_mobile_menu_contact_phone' ), wp_kses_allowed_html('post') ) ?></a></h5>
                    <?php endif ?>
                </div>
            </div>
            <?php endif ?>
        ...
        <?php if( !empty( Egns_Helpers::egns_get_theme_option('header_two_right_side_button') ) && Egns_Helpers::egns_get_theme_option('header_two_right_side_button') ) : ?>
            <div class="nav-right d-flex jsutify-content-end align-items-center gap-5">
                <?php if( !empty( Egns_Helpers::egns_get_theme_option('header_two_button_text') && Egns_Helpers::egns_get_theme_option('header_two_button_url') ) ) : ?>
                    <div class="eg-btn btn--primary2 capsule btn--lg d-xl-flex d-none">
                        <a href="<?php echo esc_url( Egns_Helpers::egns_get_theme_option('header_two_button_url') ) ?>"><?php echo esc_html( Egns_Helpers::egns_get_theme_option('header_two_button_text') ) ?>

            ...
            <?php if ((Egns_Helpers::egns_get_theme_option('header_three_right_side_contact') == 1) && class_exists('CSF')) : ?>
                <div class="hotline d-lg-none d-flex mb-30">
                    ...
                    <div class="hotline-info">
                        <?php if (!empty(Egns_Helpers::egns_get_theme_option('header_three_contact_text'))) : ?>
                            <span><?php echo esc_html(Egns_Helpers::egns_get_theme_option('header_three_contact_text')) ?></span>
                        <?php endif ?>
                        <?php if (!empty(Egns_Helpers::egns_get_theme_option('header_three_contact_value'))) : ?>
                            <h6><a href="<?php echo esc_html('tel:' . Egns_Helpers::egns_get_theme_option('header_three_contact_value')) ?>"><?php echo esc_html(Egns_Helpers::egns_get_theme_option('header_three_contact_value')) ?></a></h6>
                        <?php endif ?>
                    </div>
                </div>
            <?php endif ?>

    ...
    <header class="header-area style-5">
        <div class="nav-left">
            ...
            <div class="main-nav">
                ...
                <!-- mobile-search-area -->
                <div class="d-xl-none d-lg-none d-lg-none d-block">
                    <?php  if( class_exists('CSF') && !empty( Egns_Helpers::egns_get_theme_option('header_three_button_text') ) ) : ?>
                        <div class="eg-btn btn--primary btn--lg d-xl-none d-flex">
                            <a href="<?php echo esc_url( Egns_Helpers::egns_get_theme_option('header_three_button_url') ) ?>"><i class="bi bi-dash-lg"></i><?php echo esc_html( Egns_Helpers::egns_get_theme_option('header_three_button_text') ); ?></a>
                        </div>
                    <?php endif ?>
                </div>
                <?php if( !empty( Egns_Helpers::egns_get_theme_option('header_three_mobile_menu_contact') ) && ( 1 == Egns_Helpers::egns_get_theme_option('header_three_mobile_menu_contact') ) ) : ?>
                <div class="phone-call d-flex d-lg-none justify-content-start align-items-center flex-row d-xl-none d-block mt-5">
                    ...
                    <div class="number">
                        ...
                        <?php if( !empty( Egns_Helpers::egns_get_theme_option('header_three_right_side_contact_phone') ) ) : ?>
                            <h5><a href="tel:<?php echo wp_kses( Egns_Helpers::egns_get_theme_option( 'header_three_right_side_contact_phone' ), wp_kses_allowed_html('post') ) ?>"><?php echo wp_kses( Egns_Helpers::egns_get_theme_option( 'header_three_right_side_contact_phone' ), wp_kses_allowed_html('post') ) ?></a></h5>
                        <?php endif ?>
                    </div>
                </div>
                <?php endif ?>
            </div>
            <div class="mobile-menu-btn d-xl-none d-lg-none d-block">
                <i class="bi bi-list text-white"></i>
            </div>
            <a class="eg-btn btn--primary2 sibling2  btn--lg2 d-xxl-flex d-none" href="<?php echo esc_url( Egns_Helpers::egns_get_theme_option('header_three_button_url') ) ?>"><i class="bi bi-dash-lg"></i><?php echo esc_html( Egns_Helpers::egns_get_theme_option('header_three_button_text') ); ?></a>
        </div>

        ...
        <div class="main-menu">
            ...
            <div class="hotline d-lg-none d-flex mb-30">
                ...
                <div class="hotline-info">
                    <?php if (!empty(Egns_Helpers::egns_get_theme_option('header_three_hotline_info_text'))) : ?>
                        <span><?php echo esc_html(Egns_Helpers::egns_get_theme_option('header_three_hotline_info_text')) ?></span>
                    <?php endif ?>
                    <?php if (!empty(Egns_Helpers::egns_get_theme_option('header_three_hotline_info_number'))) : ?>
                        <h6><a href="tel:<?php echo esc_attr(Egns_Helpers::egns_get_theme_option('header_three_hotline_info_number')) ?>"><?php echo esc_html(Egns_Helpers::egns_get_theme_option('header_three_hotline_info_number')) ?></a></h6>
                    <?php endif ?>
                </div>
            </div>

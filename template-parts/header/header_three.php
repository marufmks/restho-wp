...
<header class="header-area style-3">
    <div class="container-fluid d-flex justify-content-between align-items-center">
        ...
        <div class="header-logo header-sticky-logo3">
            <?php
            if (!empty(Egns_Helpers::egns_page_option_value('header_three_sticky_logo', 'url'))) {
                Egns_Helpers::get_theme_logo(Egns_Helpers::egns_page_option_value('header_three_sticky_logo', 'url'));
            } else {
            ...
            <?php if ((Egns_Helpers::egns_get_theme_option('header_three_right_side_contact') == 1) && class_exists('CSF')) : ?>
                <div class="hotline d-lg-none d-flex mb-30">
                    ...
                    <div class="hotline-info">
                        <?php if (!empty(Egns_Helpers::egns_get_theme_option('header_three_right_side_contact_text'))) : ?>
                            <span><?php echo esc_html(Egns_Helpers::egns_get_theme_option('header_three_right_side_contact_text')) ?></span>
                        <?php endif ?>
                        <?php if (!empty(Egns_Helpers::egns_get_theme_option('header_three_right_side_contact_phone'))) : ?>
                            <h6><a href="<?php echo esc_html('tel:' . Egns_Helpers::egns_get_theme_option('header_three_right_side_contact_phone')) ?>"><?php echo esc_html(Egns_Helpers::egns_get_theme_option('header_three_right_side_contact_phone')) ?></a></h6>
                        <?php endif ?>
                    </div>
                </div>
                <?php endif ?>
                <div class="reservation-btns d-lg-none d-flex">
                    <?php if (!empty(Egns_Helpers::egns_get_theme_option('header_three_menu_button')) && (Egns_Helpers::egns_get_theme_option('header_three_menu_button')   ==  1) && class_exists('CSF')) :  ?>
                        <?php if (!empty(Egns_Helpers::egns_get_theme_option('header_three_button_text'))) :   ?>
                            <a href="<?php echo esc_url(Egns_Helpers::egns_get_theme_option('header_three_button_url')) ?>" class="primary-btn6 btn-md"><?php echo esc_html(Egns_Helpers::egns_get_theme_option('header_three_button_text')) ?></a>
                        <?php endif ?>
                    <?php endif ?>
                </div>
                </div>
                ...
                <div class="nav-right d-flex jsutify-content-end align-items-center">
                    <?php if ((Egns_Helpers::egns_get_theme_option('header_three_mobile_menu_contact') == 1) && class_exists('CSF')) : ?>
                        <div class="hotline d-flex">
                            ...
                            <div class="hotline-info">
                                <?php if (!empty(Egns_Helpers::egns_get_theme_option('header_three_mobile_menu_contact_text'))) : ?>
                                    <span><?php echo esc_html(Egns_Helpers::egns_get_theme_option('header_three_mobile_menu_contact_text')) ?></span>
                                <?php endif ?>
                                <?php if (!empty(Egns_Helpers::egns_get_theme_option('header_three_mobile_menu_contact_phone'))) : ?>
                                    <h6><a href="<?php echo esc_html('tel:' . Egns_Helpers::egns_get_theme_option('header_three_mobile_menu_contact_phone')) ?>"><?php echo esc_html(Egns_Helpers::egns_get_theme_option('header_three_mobile_menu_contact_phone')) ?></a></h6>
                                <?php endif ?>
                            </div>
                        </div>
                    <?php endif ?>
                    <?php if (Egns_Helpers::egns_get_theme_option('header_three_button_url') && Egns_Helpers::egns_get_theme_option('header_three_right_side_button') == 1 && class_exists('CSF')) : ?>
                        <a href="<?php echo esc_url(Egns_Helpers::egns_get_theme_option('header_three_button_url')) ?>" class="primary-btn6 btn-md"><?php echo esc_html(Egns_Helpers::egns_get_theme_option('header_three_button_text')) ?></a>
                    <?php endif ?>

                    <?php if ((Egns_Helpers::egns_get_theme_option('header_three_menu_sidebar') == 1) && class_exists('CSF')) :  ?>

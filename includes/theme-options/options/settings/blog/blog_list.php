<?php 
	...
	CSF::createSection( $prefix . '_theme_options', array(
		...
		'title'  => esc_html__( 'Blog Post', 'restho' ),
		'icon'   => 'fa fa-list-ul',
		'fields' => array(
			array(
				'id'         => 'blog_layout_options',
				'title'      => esc_html__( 'Blog Layout', 'restho' ),
				'type'       => 'image_select',
				'options'    => array(
				...
				'default'    => 'default',
				'desc'       => wp_kses( __( 'you can set <mark>blog layout design</mark> from blog page', 'restho' ), $allowed_html ),
			),	  
		),

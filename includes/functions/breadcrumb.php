<?php
    ...
    if ( ! function_exists( 'egns_breadcrumb' ) ) {
		 ...
		 * @since   1.0.0
		 */
        function egns_breadcrumb ( $list_style = 'ol', $list_id = 'breadcrumb', $list_class = 'breadcrumb', $active_class = 'active', $echo = true ) {
            ...
            // Search
            if ( is_search() ) {
                $breadcrumb .= '<li class="' . $active_class . '">' . esc_html__( 'Search', 'restho' ) . '</li>';
            }

            // 404
            if ( is_404() ) {
                $breadcrumb .= '<li class="' . $active_class . '">' . esc_html__( '404', 'restho' ) . '</li>';
            }
            ...
            // Ouput
            if ( $echo ) {
                echo sprintf( esc_html__("%s", 'restho'), $breadcrumb ); ;
            } else {
                return $breadcrumb;
            }
        }
